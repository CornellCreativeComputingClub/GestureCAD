...
class Hand:
    ...
    # Get line of greatest distance (not very efficient right now)
    def get_hand_line(self, filter_value=50):
        cnt = self.contours
        if len(cnt) == 0:
            return cnt
        points = []
